...
if st.session_state.logged_in:
    st.title(":rainbow[Welcome to Data World]")
    #developer info on sidebar with link
    st.sidebar.caption("Developed by:blue[ Krishna Chandhan]")
    st.sidebar.markdown("[LinkedIn](https://www.linkedin.com/in/krishna-chandhan-088831160/)")
